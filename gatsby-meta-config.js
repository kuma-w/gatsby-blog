module.exports = {
  title: `KUMA BLOG`,
  description: `KUMA BLOG`,
  language: `ko`, // `ko`, `en` => currently support versions for Korean and English
  siteUrl: `https://www.zoomkoding.com`,
  ogImage: `/og-image.png`, // Path to your in the 'static' folder
  comments: {
    utterances: {
      repo: `kuma-w/gatsby-blog`, // `kuma/gatsby-blog`,
    },
  },
  ...
  author: {
    ...
    bio: {
      role: `프론트엔드 개발자`,
      description: ['사람들에게 도움을 주고 싶은', '아름다운 것에 관심이 많은'],
      thumbnail: 'me.png', // Path to the image in the 'asset' folder
    },
    social: {
      github: `https://github.com/kuma-w`,
      // linkedIn: `https://www.linkedin.com/in/jinhyeok-jeong-800871192`,
      email: `occhoi90@gmail.com`,
    },
  },
